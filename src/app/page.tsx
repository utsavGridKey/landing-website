...
export default function WhyChooseUs() {
  ...
  return (
    <div className="overflow-x-hidden relative">
      ...
      <div
        ref={containerRef}
        className="flex flex-col relative items-center justify-center h-screen overflow-hidden [perspective:1000px] bg-[radial-gradient(circle,rgba(0,40,51,1)_0%,rgba(0,0,0,1)_40%)]  text-white"
      >
        {/* Flying O */}
        <div
          ref={dotRef}
